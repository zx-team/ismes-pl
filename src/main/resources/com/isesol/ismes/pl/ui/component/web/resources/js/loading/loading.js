...
(function() {
	...
	ol.loading=function(options) {
		...
		this.init=function(){
			...
			this.loadingText=$('<div class="ol_loading_text">正在加载中...</div>').css("z-index",options.zIndex+1);
			...
			if(!options.loadingClass)
			{
				...
				this.loadingText.addClass(options.loadingClass+"_text");
			}

			this.container.parent().append(this.loadingMask).append(this.loadingImg).append(this.loadingText);
