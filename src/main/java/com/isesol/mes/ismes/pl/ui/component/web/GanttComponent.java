...
public class GanttComponent extends ContainerComponent {
	...
	public void initial() {
		...
		this.addResource("ui.scripts", ResourceType.Javascript, "/com/isesol/ismes/pl/ui/component/web/resources/js/pl_jhpc.js", "1.0.0", true);
